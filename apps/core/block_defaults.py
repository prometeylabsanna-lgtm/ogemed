...
BLOCK_FIELD_LABELS: dict[tuple[str, str], str] = {
    ...
    ("home", "products_section_visible"): "Показувати новинки/хіти (застаріле)",
    ("home", "products_new_visible"): "Показувати блок «Новинки» на сайті",
    ("home", "products_hits_visible"): "Показувати блок «Хіти» на сайті",
...
BLOCK_DEFAULTS: dict[tuple[str, str], tuple[str, str]] = {
    ...
    ("home", "products_new_visible"): ("1", "1"),
    ("home", "products_hits_visible"): ("1", "1"),
